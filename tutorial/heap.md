...
таком порядке располагаем их в обычном массиве. В этом случае сложность преобразования массива в кучу составит **O(n)** (heapify)[https://docs.python.org/3/library/heapq.html#heapq.heapify].
